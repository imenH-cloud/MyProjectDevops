...
import {
  ...
  renderInternal
} from "./chunk-ZHEMMTFP.js";
import {
  APP_BASE_HREF,
  PlatformLocation
} from "./chunk-ASCV22BA.js";
import {
  ApplicationRef,
  Compiler,
  Console,
...
function getRoutesFromAngularRouterConfig(bootstrap, document2, url, invokeGetPrerenderParams = false, includePrerenderFallbackRoutes = true, entryPointToBrowserMapping = void 0) {
  return __async(this, null, function* () {
    ...
    try {
      ...
      const { pathname: baseHref } = new URL(rawBaseHref, "http://15.237.111.121");
...
//# sourceMappingURL=chunk-CUXBSLYO.js.map
